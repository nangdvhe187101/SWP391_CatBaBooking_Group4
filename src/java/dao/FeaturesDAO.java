...
public class FeaturesDAO {
    ...
    public List<Features> getAllFeatures() {
        ...
        // Thay đổi SELECT * thành các cột cụ thể để rõ ràng hơn
        String sql = "SELECT feature_id, feature_name, url FROM features ORDER BY feature_id";
        ...
        try (Connection conn = DBUtil.getConnection();
            ...
            while (rs.next()) {
                ...
                // Đã xóa dòng sau:
                // feature.setRequiredBusinessType(rs.getString("required_business_type"));
    ...
    public Features getFeatureById(int featureId) {
        // Thay đổi SELECT * thành các cột cụ thể
        String sql = "SELECT feature_id, feature_name, url FROM features WHERE feature_id = ?";
    ...
    public boolean addFeature(Features feature) {
        // Xóa "required_business_type" khỏi câu lệnh INSERT
        ...
        try (Connection conn = DBUtil.getConnection();
            ...
            // Đã xóa dòng sau:
            // ps.setString(3, feature.getRequiredBusinessType());
    ...
    public boolean updateFeature(Features feature) {
        // Xóa "required_business_type" khỏi câu lệnh UPDATE
        ...
        try (Connection conn = DBUtil.getConnection();
            ...
            // Cập nhật lại index của tham số feature_id từ 4 thành 3
