...
<head>
    ...
    <style>
        ...
        .mini-input-wrapper { position: relative; }
        .mini-input-wrapper i {
            position: absolute; left: 10px; top: 50%; transform: translateY(-50%);
            color: #666; font-size: 0.9rem;
        }
        .mini-input { padding-left: 32px !important; height: 38px; font-size: 0.9rem; }
        .sticky-search-btn {
